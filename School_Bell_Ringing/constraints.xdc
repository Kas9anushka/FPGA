...
set_property -dict {PACKAGE_PIN v2 IOSTANDARD LVCMOS33} [get_ports {clear}]
 set_property -dict {PACKAGE_PIN u2 IOSTANDARD LVCMOS33} [get_ports {enable}]
 set_property -dict {PACKAGE_PIN J5 IOSTANDARD LVCMOS33} [get_ports {manual_ring_btn}]
 set_property -dict {PACKAGE_PIN G1 IOSTANDARD LVCMOS33} [get_ports {bell_led}]
